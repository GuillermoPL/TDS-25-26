...
![Vista Principal](./docs/imagenes/ventana_gastos.png)
...
* **Registrar Gasto:** Pulse el botón "Añadir". Se abrirá un diálogo donde debe indicar el importe, seleccionar una fecha y elegir una categoría.
    ![Nuevo Gasto](./docs/imagenes/ventana_nuevo_gasto.png)
...
* **Por Fechas:** Seleccione un rango (ej: Abril a Agosto) para ver solo los gastos de ese periodo.
    ![Filtro Fechas](./docs/imagenes/filtro_abril_agosto.png)
* **Combinado:** Puede sumar criterios, por ejemplo, ver solo los gastos de "Alimentación" ocurridos entre Abril y Agosto.
    ![Filtro Combinado](./docs/imagenes/filtro_abril_agosto_alimentacion.png)
...
![Gestión de Categorías](./docs/imagenes/ventana_categorias.png)
...
![Error Categoría Inválida](./docs/imagenes/categoria_invalida.png)
...
![Configuración Alertas](./docs/imagenes/ventana_alertas.png)
...
1.  **Reparto Equitativo:** El gasto se divide a partes iguales entre todos los miembros.
    ![Cuenta Equitativa](./docs/imagenes/cuenta_equitativa.png)
...
2.  **Reparto Porcentual:** Usted define qué porcentaje del gasto asume cada usuario.
    ...
    ![Cuenta Porcentual](./docs/imagenes/cuenta_porcentual.png)
...
![Gasto Compartido](./docs/imagenes/registrar_gasto_cuenta_compartida.png)
...
* **Gráfica Circular (Pie Chart):** Vea rápidamente en qué categorías está gastando más dinero.
    ![Gráfica Circular](./docs/imagenes/grafica_circular.png)

* **Vista Calendario:** Examine sus gastos distribuidos día a día en un calendario interactivo.
    ![Calendario](./docs/imagenes/calendario.png)
...
![Modo Consola](./docs/imagenes/linea_comandos.png)
